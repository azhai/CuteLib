...
class Compiler
{
    ...
    public function setSourceDir($source_dir)
    {
        ...
        $loader_fs = new \Twig_Loader_Filesystem(array($this->source_dir));
     ...
     */
    public function compileFile($source_file, $compiled_file, array $context = array())
    {
     ...
     * @return string
     */
    public function compileTpl($template_file, $source_file = '', array $context = array())
    {
     ...
     * @return int 成功编译文件数量
     */
    public function compileAll($dir = false, array $context = array())
    {
